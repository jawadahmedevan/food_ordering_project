                            ...
                            <span>Taka. '.$row1['price'].'</span>
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>Taka. '.$row['total'].'</strong></span>
                                            </div>';
								if(!$deleted){
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        ...
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Jawad Ahmed</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
